...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative px-4 pt-28 pb-20 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center">
        {/* Tagline */}
        <ScrollReveal>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            <span className="text-primary">Zero to private</span>
            <br />
            <span className="text-zinc-100">in one command</span>
          </h1>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.1}>
          <p className="text-lg text-zinc-400 mb-10 max-w-xl mx-auto leading-relaxed">
            The CLI for Solana privacy development. Scaffold production-ready projects with Privacy Cash, Light Protocol, or Arcium.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.3}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-zinc-400 hover:text-zinc-100 transition-colors duration-150"
            >
