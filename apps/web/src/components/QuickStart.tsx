          ...
          {steps.map((step) => (
            <div key={step.number} className="flex gap-4">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center gap-2 bg-zinc-800/50 border border-border rounded-lg px-4 py-2">
                  <code className="flex-grow font-mono text-sm text-terminal-green">
                    {step.code}
                  </code>
